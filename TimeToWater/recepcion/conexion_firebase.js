...
function inicializar(){
   ...
   // formConvalidaciones.addEventListener("submit", enviarConvalidacionAFirebase, false)
    ...
    refConvalidaciones = firebase.database().ref().child("plantita");
...
function mostrarConvalidacionesDeFirebase(){
    refConvalidaciones.on("value", function(snap){
        ...
        for(var key in datos){
            filasAmostrar += "<tr>" +
                                "<td>" + datos[key].temperaturaAmbiente + "</td>" +
                                "<td>" + datos[key].humedadTierra + "</td>" +
                                "<td>" + datos[key].humedadAmbiente + "</td>" +
                                "<td>" + "Estado" + "</td>" +
                                '<td>' + '</td>' +
                             "</tr>";
        }
